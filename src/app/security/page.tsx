    ...
    <ProtectedRoute requiredRole="OWNER">
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 md:p-8" dir={language === 'ar' ? 'rtl' : 'ltr'}>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">{t('security.noUsersFound')}</p>
              </div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50/50">
                    <tr>
                      <th className={`px-6 py-4 text-sm font-semibold text-gray-700 ${textAlignClass}`}>
                        {t('security.username')}
                      </th>
                      <th className={`px-6 py-4 text-sm font-semibold text-gray-700 ${textAlignClass}`}>
                        {t('security.fullName')}
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('security.addUser')}</h2>
              ...
              <form onSubmit={handleCreateUser} className="space-y-4">
                ...
                <div className="flex justify-end space-x-4 pt-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 disabled:opacity-50"
                  >
        ...
        {showEditModal && selectedUser && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('security.editUser')}</h2>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl p-6 w-full max-w-md">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('security.deleteUser')}</h2>
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors duration-200 disabled:opacity-50"
                  >
